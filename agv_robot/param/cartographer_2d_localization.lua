...
TRAJECTORY_BUILDER_2D.max_range = 9.999
...
--TRAJECTORY_BUILDER_2D.adaptive_voxel_filter.max_range=0.1*TRAJECTORY_BUILDER_2D.adaptive_voxel_filter.max_range
...
POSE_GRAPH.constraint_builder.sampling_ratio = 0.8 * POSE_GRAPH.constraint_builder.sampling_ratio
POSE_GRAPH.global_sampling_ratio = 0.8 * POSE_GRAPH.global_sampling_ratio
